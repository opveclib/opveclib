...
# -*- coding: utf-8 -*-
#
# opveclib documentation build configuration file, created by
# sphinx-quickstart on Fri May 20 08:50:59 2016.
#
...
# make sure to import the source in this repo and not an installed
#  version of opveclib, so that docs are generated from source
        ...
        for line in f:
            ...
            if is_import and not is_comment:
                ...
                for name in names:
                    ...
                    if attr is op.Scalar or attr is op.Variable:
                        api_file.write('.. autoclass:: opveclib.' + attr_name + '\n'
                                       '    :members:\n'
                                       '    :undoc-members:\n'
                                       '    :special-members:\n'
                                       '    :exclude-members: __init__, __bool__, __module__, __radd__,__rdiv__,'
                                                                                '__rmod__,__rmul__,__rsub__, '
                                                                                'as_proto, from_proto, gen_c\n'
                                       '\n')
                    elif attr in [op.LocalTensor, op.PositionTensor, op.OutputTensor, op.InputTensor]:
                        api_file.write('.. autoclass:: opveclib.' + attr_name + '\n'
                                       '    :members:\n'
                                       '    :undoc-members:\n'
                                       '    :special-members:\n'
                                       '    :inherited-members:\n'
                                       '    :exclude-members: __init__, __module__, __class__, __delattr__, __dict__, '
                                                             '__format__, __getattribute__, __hash__, __ilshift__, '
                                                             '__new__, __reduce__, __reduce_ex__, __repr__, '
                                                             '__setattr__, __sizeof__, __str__, __subclasshook__, '
                                                             '__weakref__, as_proto, from_proto, gen_c, gen_ptr\n'
                                       '\n')
...
# include both the class and constructor doc content
...
project = u'opveclib'
copyright = u'2016, Hewlett Packard Enterprise Development LP'
author = u'opveclib team'
...
latex_documents = [
    (master_doc, 'opveclib.tex', u'opveclib Documentation',
     u'opveclib team', 'manual'),
]
...
man_pages = [
    (master_doc, 'opveclib', u'opveclib Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'opveclib', u'opveclib Documentation',
     author, 'opveclib', 'One line description of project.',
     'Miscellaneous'),
]
